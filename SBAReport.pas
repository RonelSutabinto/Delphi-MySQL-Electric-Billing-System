...
uses
  ...
  DB, QRCTRLS, QUICKRPT, ExtCtrls, ComCtrls;

type
  TSBAReportForm = class(TForm)
    ...
    QRLabel36: TQRLabel;
    CheckedBy: TQRLabel;
    CheckedByPosition: TQRLabel;
    QRLabel61: TQRLabel;
    NotedBy: TQRLabel;
    NotedByPosition: TQRLabel;
    TabSheet3: TTabSheet;
    SalesReport1: TQuickRep;
    QRBand4: TQRBand;
    ...
    QRLabel64: TQRLabel;
    PrepareName: TQRLabel;
    PreparePosition: TQRLabel;
    TabSheet4: TTabSheet;
    SalesReport2: TQuickRep;
    QRBand17: TQRBand;
