object callerHistoryFrm: TcallerHistoryFrm
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'callerHistoryFrm'
  ClientHeight = 614
  ClientWidth = 366
  Color = clBtnFace
  ...
  object AdvPanel1: TAdvPanel
    ...
    object number_lb2: TAdvSmoothLabel
      ...
      Caption.ColorStart = 12615680
      Caption.ColorEnd = 16636802
  ...
  object manageOutQ: TMyQuery
    ...
    SQL.Strings = (
      'Select m.*,concat(type,number) qNumber '
      'from manageout m '
      '-- where date = :date '
      'order by entry desc')
    Left = 176
