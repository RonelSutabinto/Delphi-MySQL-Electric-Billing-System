...
begin
   ...
   BillMenuForm.Caption               := SpinEdit1.Text;// 'Flexi Billing Ver.1.8.0.5 ( Billing Clerk: '+ SpinEdit1.Text+' )';
   BillMenuForm.Show;
   Hide;
...
begin
  case area_CBox.ItemIndex of
    0:begin
      ...
      TmpQuery.SQL.Clear;
      TmpQuery.SQL.Add('ALTER TABLE `zaneco`.`soasign` ');
      TmpQuery.SQL.Add(' ADD COLUMN `notice48hrs` VARCHAR(45) NULL DEFAULT ''LOU MARVIN D. SAGARIO'' AFTER `gm_DL`, ');
      TmpQuery.SQL.Add('ADD COLUMN `position48hrs` VARCHAR(45) NULL DEFAULT ''CAD Manager'' AFTER `notice48hrs`;');
      try
        TmpQuery.Execute;
      except
      end;
    ...
    1:begin
     // DBlog := 1;
      ...
      TmpQuery.SQL.Clear;
      TmpQuery.SQL.Add('ALTER TABLE `zaneco`.`soasign` ');
      TmpQuery.SQL.Add(' ADD COLUMN `notice48hrs` VARCHAR(45) NULL DEFAULT ''ELMER B. DIGAMON'' AFTER `gm_DL`, ');
      TmpQuery.SQL.Add('ADD COLUMN `position48hrs` VARCHAR(45) NULL DEFAULT ''LAS Manager'' AFTER `notice48hrs`;');
      try
        TmpQuery.Execute;
      except
      end;
    ...
    2:begin
      ...
      TmpQuery.SQL.Clear;
      TmpQuery.SQL.Add('ALTER TABLE `zaneco`.`soasign` ');
      TmpQuery.SQL.Add(' ADD COLUMN `notice48hrs` VARCHAR(45) NULL DEFAULT ''RONALD A. LAPINIG'' AFTER `gm_DL`, ');
      TmpQuery.SQL.Add('ADD COLUMN `position48hrs` VARCHAR(45) NULL DEFAULT ''PAS Manager'' AFTER `notice48hrs`;');
      try
        TmpQuery.Execute;
      except
      end;
    ...
    3:begin
     // DBlog := 3;
      ...
      TmpQuery.SQL.Clear;
      TmpQuery.SQL.Add('ALTER TABLE `zaneco`.`soasign` ');
      TmpQuery.SQL.Add(' ADD COLUMN `notice48hrs` VARCHAR(45) NULL DEFAULT ''ELMAR A. MARTINEZ'' AFTER `gm_DL`, ');
      TmpQuery.SQL.Add('ADD COLUMN `position48hrs` VARCHAR(45) NULL DEFAULT ''SAS Manager'' AFTER `notice48hrs`;');
      try
        TmpQuery.Execute;
      except
      end;
