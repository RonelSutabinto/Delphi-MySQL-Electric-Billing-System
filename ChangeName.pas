...
begin
  ...
  changenameQ.ParamByName('datefromA').text := FormatDateTime('m/d/yyyy',NxDatePicker1.Date);
  changenameQ.ParamByName('datetoA').text :=  FormatDateTime('m/d/yyyy',NxDatePicker2.Date);
