        ...
        0:begin
         ...
         1:begin
          try
            ...
            number_lb2.Caption.Text  := 'Consumer Priority Number (Piñan Area).';
            showmessage('Queuing Piñan area successfully connected..')
          except
                MessageDlg('PIÑAN AREA OFFLINE..', mtWarning, [mbOK], 0);
          end;
          end;
         2:begin
          try
