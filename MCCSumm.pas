...
begin
  ...
  begin
      ...
      Retrieve.SQL.Add('        when "005" then "SERGIO OSMEÑA"');
      Retrieve.SQL.Add('        when "006" then "DAPITAN"');
      Retrieve.SQL.Add('        when "007" then "PIÑAN"');
      ...
      Retrieve.SQL.Add('        when "024" then "DAPITAN / PIÑAN"');
      ...
      17: Retrieve.SQL.Add('  sum(ifnull(Fitall,0)),');
      18: Retrieve.SQL.Add('  sum(ifnull(PARec,0)),');
      end;
