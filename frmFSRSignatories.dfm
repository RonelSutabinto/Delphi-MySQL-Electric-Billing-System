object FSRSignatories: TFSRSignatories
  Left = 0
  Top = 0
  Caption = 'FSRSignatories'
  ClientHeight = 272
  ClientWidth = 668
  Color = clBtnFace
  ...
  object qFSRSignatories: TMyQuery
    ...
    Left = 600
    Top = 136
    object qFSRSignatoriesCheckBy: TStringField
      FieldName = 'CheckBy'
      Size = 50
    end
    object qFSRSignatoriesCheckPos: TStringField
      FieldName = 'CheckPos'
      Size = 50
    end
    object qFSRSignatoriesReviewedBy: TStringField
      FieldName = 'ReviewedBy'
      Size = 50
    end
    object qFSRSignatoriesReviewedPos: TStringField
      FieldName = 'ReviewedPos'
      Size = 50
    end
    object qFSRSignatoriesCertTCBy: TStringField
      FieldName = 'CertTCBy'
      Size = 50
    end
    object qFSRSignatoriesCertTCPos: TStringField
      FieldName = 'CertTCPos'
      Size = 50
    end
    object qFSRSignatoriesAttestedBy: TStringField
      FieldName = 'AttestedBy'
      Size = 50
    end
    object qFSRSignatoriesAttestedPos: TStringField
      FieldName = 'AttestedPos'
      Size = 50
    end
    object qFSRSignatoriesidfsrsignatories: TIntegerField
      FieldName = 'idfsrsignatories'
    end
    object qFSRSignatoriesPreparedBy: TStringField
      FieldName = 'PreparedBy'
      Size = 255
    end
    object qFSRSignatoriesPreparedPos: TStringField
      FieldName = 'PreparedPos'
      Size = 255
    end
  end
  object dsFSRSignatories: TMyDataSource
    DataSet = qFSRSignatories
    Left = 600
    Top = 184
  end
